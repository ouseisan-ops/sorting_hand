...
const questions = [
    ...
    { id: "C", text: "提前做好计划让我感到安心。" },
    { id: "I", text: "学习新知识让我感到兴奋。" },
    { id: "C", text: "我注重细节，总能发现文档中的小错误。" },
    { id: "S", text: "朋友向我倾诉时，我能感同身受并提供情绪支持。" },
    { id: "R", text: "我会把感兴趣的东西拆开，分析结构后再重新组装。" },
    { id: "C", text: "我喜欢在清晰、明确的指令下工作。" },
    { id: "E", text: "向别人推销我的想法或产品，能让我感到满足。" },
    { id: "E", text: "我讨厌被别人比下去。" },
    { id: "C", text: "我喜欢处理表格、整理文件。" },
    { id: "E", text: "我喜欢在团队中组织大家协作，而不是独自完成任务。" },
    { id: "A", text: "我的想象力很丰富。" },
...
const comboData = {
    ...
    RI: { title: "RI：技术研发者", desc: "动手+研究：技术专家型。不仅能动手做，还喜欢钻研背后的原理。逻辑思维强。", careers: "软件工程师、芯片研发、AI算法工程师、程序员、科研人员、无线网及移动通信顾问", majors: "先进微电子技术与材料（研究型）、低碳电力与能源、材料科学与工程、生物信息学（研究型）、多媒体通信" },
    ...
    AR: { title: "AR：匠心实造者", desc: "创造+动手：实用艺术。喜欢动手制作产品，注重细节和品质。", careers: "服装设计师、摄影师、舞蹈演员、建筑师、珠宝设计师、产品造型师、空间摄影师", majors: "国际建筑专业实践、土木工程、工业设计、媒介与传播、城市规划与设计" },
    ...
    CE: { title: "CE：高效组织运营官", desc: "规范+企划：商务型专家。对商业流程非常熟悉，注重合规和执行。", careers: "财务主管、项目运营经理、合规审计师、税务顾问、商务运营管理", majors: "专业会计、管理学、药学-制药管理方向、精算学、金融学、运营与供应链管理" },
