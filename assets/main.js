...
const comboData = {
    ...
    RS: {
        ...
        majors: "环境科学（研究型）、数字化教育-学习与教学方向、对外英语教育、创业与创新专业-可持续解决方案与创新技术应用、创业与创新-智慧康养管理方向"
    },
    IA: {
        title: "IA：🧠思想深邃的研究者",
    ...
    IE: {
        ...
        majors: "商业分析、投资管理、数字化商业、管理学、经济与金融、创业与创新专业-风险投资/企业和谐治理、创新与传承等方向"
    },
    IR: {
        title: "IR：🔬数字世界探险者",
    ...
    SA: {
        ...
        majors: "儿童发展与家庭教育学、数字化教育、对外英语教育、应用语言学、媒介与传播、创业与创新-智慧康养管理方向、创业与创新-企业和谐治理方向"
    },
    SC: {
        title: "SC：📋秩序型社会服务",
        desc: "靠谱小管家 + 贴心办事员：心思缜密，细致周到，偏爱井然有序，看似一本正经，实则最爱帮大家排忧解难！",
        careers: "教务管理、行政助理、客户服务经理、职业规划师、社会工作者、人力资源、教务主任",
        majors: "国际化教育-课程与教学方向、儿童发展与家庭教育学、对外英语、创业与创新-企业和谐治理方向、创业与创新-智慧康养管理方向"
    },
    SE: {
        title: "SE：🎯团队赋能核心",
    ...
    CE: {
        ...
        majors: "专业会计、管理学、药学（研究型）-制药管理方向、精算学、金融学、运营与供应链管理、创业与创新-企业和谐治理方向、创业与创新-智慧康养管理方向"
    },
    CI: {
        title: "CI：🧮数据精算专家",
    ...
    CR: {
        ...
        majors: "项目管理、可持续房屋设计与工程、可持续能源技术、先进机器人技术系统、国际工商管理（非全日制）、创业与创新-智慧城市方向、创业与创新-企业和谐治理方向"
    },
    CS: {
        title: "CS：🧑‍💼合规服务管家",
        desc: "贴心管家 + 合规达人：做事细致周到，心有规则底线，会在合规框架内提供超贴心的支持！",
        careers: "银行柜员、出纳、人力资源(HR)、法务、客户服务经理、公共事务主管、行政专员",
        majors: "专业会计、药学（研究型）-药事监管科学方向、国际化教育-行政与管理方向、创业与创新-企业和谐治理方向、创业与创新-智慧康养管理方向"
    }
};
